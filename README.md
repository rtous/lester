...
(v0.1.8-alpha. Already usable but not very user friendly yet.)

[MacOS Installer (Apple Silicon)](https://github.com/rtous/lester/releases/download/v0.1.8-alpha/Lester-Installer.dmg)
