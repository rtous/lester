...
(v0.1.6-alpha. Still incomplete and unstable but masks propagation critically improved.)

[MacOS Installer (Apple Silicon)](https://github.com/rtous/lester/releases/download/v0.1.6-alpha/Lester-Installer.dmg)
